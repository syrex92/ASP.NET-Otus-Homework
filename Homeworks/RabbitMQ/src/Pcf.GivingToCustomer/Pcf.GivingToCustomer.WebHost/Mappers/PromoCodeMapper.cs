...
namespace Pcf.GivingToCustomer.WebHost.Mappers
{
    ...
    {
        public static PromoCode MapFromModel(PromocodeIssued request, Preference preference, IEnumerable<Customer> customers)
        {

            var promocode = new PromoCode();
            promocode.Id = new Guid(request.PromoCode);
